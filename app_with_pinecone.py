...
# def add_pdf_to_vectorstore(pdf_path):
#     """Add PDF to Pinecone using inference API with BATCH PROCESSING."""
#     global pinecone_index
...
#         # Process in smaller batches to avoid 413 error
#         EMBED_BATCH_SIZE = 50  # Embed max 50 texts at a time
#         UPSERT_BATCH_SIZE = 100  # Upsert max 100 vectors at a time
